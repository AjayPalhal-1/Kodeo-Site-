...
export default function Home() {
  ...
  <h1>
Code to Deployment—We Handle It All    
  </h1>
  <p className="lead">
From user interface to server-side logic, we build robust, secure, and scalable digital products. </p>
</Container>
...
In the digital era, having a seamless and high-performing application is critical for success. At Kodeo Software Technology, we offer full stack development solutions that cover everything from elegant UI/UX design to powerful backend infrastructure. Our team is proficient in the latest frontend technologies like React, Angular, and Vue.js, as well as backend frameworks such as Node.js, Django, Laravel, and Spring Boot. We build web and mobile applications that are responsive, secure, and scalable. Whether you're launching a startup product or modernizing enterprise software, we ensure your system is built with maintainability and performance in mind. APIs, databases, deployment pipelines, cloud integration—we handle it all. Partner with us to create digital solutions that are fast, functional, and future-ready.</p>
...
<Row>
  {[
    ...
    },
    {
      ...
      image: "/imgs/database.jpg", // Use appropriate image path
      points: [
            ...
            {step.icons.map((icon, j) => (
              <Col xs={6} key={j} className="mb-3">
                <div className="text-center">
                  ...
                  <p className="mt-2">{step.title.split(" ")[0]} {j + 1}</p>
                </div>
              </Col>
            ))}
          </Row>
