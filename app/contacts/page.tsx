        ...
        <div className="container-fluid px-0">
            ...
            <div className="row g-0 bg-white py-5 px-3 px-md-5 align-items-center">
                ...
                <div className="col-md-6 mb-4 mb-md-0 pe-md-5">
                    ...
                    <p>Office no.733, Gera Imperium Rise, Wipro Circle,<br />Hinjewadi Phase 2, Pune, 411057</p>
                    <hr />
                    ...
                    <p>kodeosoftwaretechnology@gmail.com</p>
                    <hr />
                    <h5 className="fw-bold mb-3">Website</h5>
                    <p>www.kodeosoftwaretechnology.com</p>
                </div>
                {/* Right: Google Map */}
                <div className="col-md-6">
                    <div className="ratio ratio-4x3 rounded-4 overflow-hidden shadow" style={{ minHeight: 320 }}>
                        <iframe
